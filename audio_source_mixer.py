...
class AudioSourceMixer(ThreadSource):
    ...
    def get_bytes(self, *args, **kwargs):
        ...
        if self.on_current_step_changed is not None:
            ...
            # indication is matching when the sound will be really
            # played (this is due to audio intermediate buffers latency).
            # We choose 2 steps offset as it's giving good results.
