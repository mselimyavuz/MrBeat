...
class TrackWidget(BoxLayout):
    def __init__(self, sound, audio_engine, nb_steps, track_source, steps_left_align, **kwargs):
        ...
        # 2 - group sound_button and separator_image in a BoxLayout (width = steps_left_align)

        sound_button_and_separator_layout = BoxLayout()
        sound_button_and_separator_layout.size_hint_x = None
        sound_button_and_separator_layout.width = steps_left_align
        self.add_widget(sound_button_and_separator_layout)

        sound_button = TrackSoundButton()
        sound_button.text = sound.displayname
        sound_button.on_press = self.on_sound_button_press
        sound_button_and_separator_layout.add_widget(sound_button)

        # separator
        separator_image = Image(source="images/track_separator.png")
        separator_image.size_hint_x = None
        separator_image.width = dp(15)
        sound_button_and_separator_layout.add_widget(separator_image)
